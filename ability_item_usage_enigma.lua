...
Consider[5] = function()
	...
	local allys = AbilityExtensions:Filter(AbilityExtensions:GetNearbyNonIllusionHeroes(npcBot),
		function(t) return AbilityExtensions:NotRetreating(t) end)
	...
	channelingEnemies = AbilityExtensions:Filter(channelingEnemies,
		function(t) return AbilityExtensions:IsChannelingAbility(t) and not t:IsInvulnerable() and t:CanBeSeen() end)
	channelingEnemies = AbilityExtensions:Map(channelingEnemies, function(t) return { t, t:GetCurrentActiveAbility() } end)
	channelingEnemies = AbilityExtensions:Map(channelingEnemies,
		function(t) return { t[1], t[2] and t[2]:GetCooldown() or 25 } end)
	...
	local enemies = AbilityExtensions:Filter(AbilityExtensions:GetNearbyNonIllusionHeroes(npcBot),
		function(t) return CanCast[4](t) end)
